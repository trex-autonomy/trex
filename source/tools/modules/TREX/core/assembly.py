...
def construct_test_assembly():
  ...
  assembly.tokens[0] = Token(0,"test_token",0,0)
  assembly.tokens[1] = Token(1,"test_slave_token",1,0)
  assembly.tokens[2] = Token(2,"test_inactive_slave_token",1,1)
  assembly.slots[0] = Slot(0,[assembly.tokens[0]])
  assembly.slots[1] = Slot(1,[assembly.tokens[1],assembly.tokens[2]])
  assembly.rules[1] = Rule(2,"test_rule",assembly.tokens[0],"/dev/null",0,[assembly.tokens[1]])
  assembly.vars[0] = Variable(3,"test_var",assembly.tokens[0],"BOOL","[TRUE FALSE MAYBE]","ENUMERATED_DOMAIN")
